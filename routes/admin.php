...
Route::group(['prefix'=>'admin'],function(){
  ...
  Route::get('/jobs/onlydeleted',[JobsController::class,'onlydeleted'])->name('onlydeleted');
  ...
  Route::get('/restore/{id}',[JobsController::class,'restore'])->name('restorejob');
  Route::get('/ForceDelete/{id}',[JobsController::class,'ForceDelete'])->name('ForceDelete');
